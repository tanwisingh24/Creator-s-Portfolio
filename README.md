...
Usage
Use the left Edit panel and the section tabs (Profile, Gallery, Collabs, Stats, Reviews, Skills, Services, Contact, Theme, Sections) to fill in your details.
Switch to the Preview tab in the top bar to see the full rendered portfolio.
Use Copy Link to copy the current page URL, or Reset to restore the default sample data.
License
